...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView mincrementage,mincrementweight,mdecreaseweight,mdecreseage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdecreseage=findViewById(R.id.decreaseage);
        ...
        mdecreseage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intage=intage-1;
                age2=String.valueOf(intage);
